...
export BERT_DIR=BERT-flow/uncased_L-12_H-768_A-12

if [[ $BERT_NAME == "large-wwm" ]];then
  export BERT_DIR=BERT-flow/wwm_uncased_L-24_H-1024_A-16
elif [[ $BERT_NAME == "large" ]];then
  export BERT_DIR=BERT-flow/uncased_L-24_H-1024_A-16
else
  export BERT_DIR=BERT-flow/uncased_L-12_H-768_A-12
fi
